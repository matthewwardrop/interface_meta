...
from interface_meta.utils.inspection import (
    _get_member, functional_delattr, functional_getattr, functional_hasattr,
    functional_setattr, get_class_attr_docs, get_functional_docs,
...
def test_get_functional_wrapper():
    ...
    for functional in [PROPERTY, METHOD, CLASS_METHOD, STATIC_METHOD]:
        ...
        for attr in ['__doc__', '_quirks_method', '_quirks_mro', '__override__', '__override_force__']:
